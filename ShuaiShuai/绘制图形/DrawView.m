...
//    [path addLineToPoint:CGPointMake(self.bounds.size.width, 300)];
//    
//    
//    [path addQuadCurveToPoint:CGPointMake(0, 300) controlPoint:CGPointMake(self.bounds.size.width/2, 500)];
//    
//    path.lineWidth = 5.0;
...
- (void)drawRect:(CGRect)rect {
    ...
    //一个不透明类型的Quartz 2D绘画环境,相当于一个画布,可以在上面任意绘画
    CGContextRef context = UIGraphicsGetCurrentContext();
    
    
    /*写文字*/
    CGContextSetRGBFillColor(context, 1, 0, 0, 1.0);///设置填充色
    ...
    /*画图*/
    ///边框圆
    CGContextSetRGBStrokeColor(context, 1, 1, 1, 1.0);///设置画笔色
